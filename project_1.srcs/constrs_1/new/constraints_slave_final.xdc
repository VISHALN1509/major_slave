...
## Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { GPIO_2[0] }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { GPIO_2[1] }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
set_property -dict { PACKAGE_PIN B9    IOSTANDARD LVCMOS33 } [get_ports { GPIO_2[2] }]; #IO_L11N_T1_SRCC_16 Sch=btn[2]
set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { GPIO_2[3] }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
...
#set_property -dict { PACKAGE_PIN A11 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_0_io2_io }]
#set_property -dict { PACKAGE_PIN D12 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_0_io3_io }]
...
## ============================================================
## SPI 1 + UART 1
## Moved off PMOD JB. Uses ChipKit Outer Digital Header.
## SPI 1 = 6 SPI pins (IO0-IO3, SCK, SS)
## UART 1 = 2 pins
## ============================================================
...
#set_property -dict { PACKAGE_PIN P14 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_1_io2_io }]
#set_property -dict { PACKAGE_PIN T11 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_1_io3_io }]
...
## ============================================================
## SPI 2 + UART 2
## Moved off PMOD JC. Uses ChipKit digital Header.
## SPI 2 = 6 SPI pins (IO0-IO3, SCK, SS)
## UART 2 = 2 pins
## ============================================================
...
#set_property -dict { PACKAGE_PIN V17 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_2_io2_io }]
#set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_2_io3_io }]
...
#set_property -dict { PACKAGE_PIN F4 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_3_io2_io }]
#set_property -dict { PACKAGE_PIN F3 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_3_io3_io }]
...
## ============================================================
## SPI 4 - SLAVE FPGA <-> MASTER FPGA
## Uses remaining ChipKit digital GPIO pins.
## SPI 4 = 4 SPI pins (IO0, IO1, SCK, SS) - STANDARD SPI
## This is the dedicated board-to-board SPI link.
## ============================================================
...
#set_property -dict { PACKAGE_PIN N14 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_4_io2_io }]
#set_property -dict { PACKAGE_PIN U17 IOSTANDARD LVCMOS33 } [get_ports { SPI_0_4_io3_io }]
