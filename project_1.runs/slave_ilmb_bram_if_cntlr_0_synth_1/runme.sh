...
HD_PWD='C:/Rohit/project_1/project_1.runs/slave_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slave_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slave_ilmb_bram_if_cntlr_0.tcl
