...
HD_PWD='C:/Rohit/project_1/project_1.runs/slave_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slave_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slave_blk_mem_gen_0_0.tcl
