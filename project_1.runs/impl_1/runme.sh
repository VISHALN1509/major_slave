...
HD_PWD='C:/Rohit/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log slave_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source slave_wrapper.tcl -notrace
