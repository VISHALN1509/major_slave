...
HD_PWD='C:/Rohit/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slave_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slave_wrapper.tcl
