...
#
# Generated by Vivado on Wed Sep 09 11:54:05 +0530 2026
...
#
#    "C:/Rohit/project_1/project_1.srcs/constrs_1/new/Master.xdc"
#    "C:/Rohit/project_1/project_1.srcs/constrs_1/new/old constraint.xdc"
#    "C:/Rohit/project_1/project_1.srcs/utils_1/imports/synth_1/slave_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../Rohit/project_1/project_1.srcs/constrs_1/new/Master.xdc"]"\
 "[file normalize "$origin_dir/../../../Rohit/project_1/project_1.srcs/constrs_1/new/old constraint.xdc"]"\
 "[file normalize "$origin_dir/../../../Rohit/project_1/project_1.srcs/utils_1/imports/synth_1/slave_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/../../../Rohit/project_1"]"
...
set_property -name "top" -value "slave_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../../Rohit/project_1/project_1.srcs/constrs_1/new/Master.xdc"]"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../../Rohit/project_1/project_1.srcs/constrs_1/new/old constraint.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/old constraint.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set file "synth_1/slave_wrapper.dcp"
...
# Proc to create BD slave
proc cr_bd_slave { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name slave
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  set SPI_0_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 SPI_0_1 ]

  set SPI_0_2 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 SPI_0_2 ]

  set SPI_0_3 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 SPI_0_3 ]

  set SPI_0_4 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 SPI_0_4 ]
  ...
  set_property CONFIG.NUM_PORTS {11} $xlconcat_0
  ...
  connect_bd_intf_net -intf_net axi_intc_0_interrupt [get_bd_intf_pins microblaze_0/INTERRUPT] [get_bd_intf_pins axi_intc_0/interrupt]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins axi_uartlite_1/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins axi_uartlite_2/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins axi_uartlite_3/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_pins axi_quad_spi_1/AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins axi_quad_spi_2/AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_interconnect_0/M07_AXI] [get_bd_intf_pins axi_quad_spi_3/AXI_LITE]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M09_AXI [get_bd_intf_pins axi_timer_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M09_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M10_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins axi_interconnect_0/M10_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M11_AXI [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M11_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M12_AXI [get_bd_intf_pins axi_interconnect_0/M12_AXI] [get_bd_intf_pins axi_quad_spi_4/AXI_LITE]
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_ports SPI_0_3] [get_bd_intf_pins axi_quad_spi_0/SPI_0]
  connect_bd_intf_net -intf_net axi_quad_spi_1_SPI_0 [get_bd_intf_ports SPI_0_2] [get_bd_intf_pins axi_quad_spi_1/SPI_0]
  connect_bd_intf_net -intf_net axi_quad_spi_2_SPI_0 [get_bd_intf_ports SPI_0_1] [get_bd_intf_pins axi_quad_spi_2/SPI_0]
  connect_bd_intf_net -intf_net axi_quad_spi_3_SPI_0 [get_bd_intf_ports SPI_0_0] [get_bd_intf_pins axi_quad_spi_3/SPI_0]
  connect_bd_intf_net -intf_net axi_quad_spi_4_SPI_0 [get_bd_intf_ports SPI_0_4] [get_bd_intf_pins axi_quad_spi_4/SPI_0]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports UART_0] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net axi_uartlite_1_UART [get_bd_intf_ports UART_2] [get_bd_intf_pins axi_uartlite_1/UART]
  connect_bd_intf_net -intf_net axi_uartlite_2_UART [get_bd_intf_ports UART_1] [get_bd_intf_pins axi_uartlite_2/UART]
  ...
  # Create port connections
  connect_bd_net -net Net  [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] \
  ...
  [get_bd_pins axi_quad_spi_2/s_axi_aresetn] \
  [get_bd_pins axi_quad_spi_3/s_axi_aresetn] \
  ...
  [get_bd_pins axi_quad_spi_4/s_axi_aresetn] \
  [get_bd_pins axi_interconnect_0/M12_ARESETN]
  connect_bd_net -net Net1  [get_bd_pins clk_wiz_1/clk_out2] \
  [get_bd_pins axi_quad_spi_4/ext_spi_clk] \
  [get_bd_pins axi_quad_spi_3/ext_spi_clk] \
  [get_bd_pins axi_quad_spi_2/ext_spi_clk] \
  ...
  connect_bd_net -net axi_quad_spi_2_ip2intc_irpt  [get_bd_pins axi_quad_spi_2/ip2intc_irpt] \
  [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net axi_quad_spi_3_ip2intc_irpt  [get_bd_pins axi_quad_spi_3/ip2intc_irpt] \
  [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net axi_quad_spi_4_ip2intc_irpt  [get_bd_pins axi_quad_spi_4/ip2intc_irpt] \
  ...
  connect_bd_net -net axi_uartlite_2_interrupt  [get_bd_pins axi_uartlite_2/interrupt] \
  [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_uartlite_3_interrupt  [get_bd_pins axi_uartlite_3/interrupt] \
  ...
  [get_bd_pins axi_quad_spi_2/s_axi_aclk] \
  ...
  [get_bd_pins axi_quad_spi_4/s_axi_aclk] \
  ...
  assign_bd_address -offset 0x44A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_quad_spi_2/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x44A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_quad_spi_3/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x44A40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_quad_spi_4/AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x40630000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_uartlite_3/S_AXI/Reg] -force
...
cr_bd_slave ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files slave.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files slave.bd ] 
set_property IS_ENABLED "1" [get_files slave.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files slave.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files slave.bd ] 
set_property PFM_NAME "" [get_files slave.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files slave.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files slave.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files slave.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files slave.bd ] 
set_property USED_IN_SIMULATION "1" [get_files slave.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files slave.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list slave.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../Rohit/project_1/project_1.gen/sources_1/bd/slave/hdl/slave_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list slave.bd]] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/slave_wrapper.dcp" -objects $obj
