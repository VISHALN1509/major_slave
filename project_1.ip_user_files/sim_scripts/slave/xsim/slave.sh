...
#
# Script generated by Vivado on Thu Aug 27 22:19:20 +0530 2026
...
#
# Usage        : slave.sh
#                slave.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                slave.sh [-reset_run]
#                slave.sh [-reset_log]
#                slave.sh [-help]
#
...
# script info
echo -e "slave.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./slave.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_35 -L fifo_generator_v13_2_13 -L axi_data_fifo_v2_1_35 -L axi_crossbar_v2_1_37 -L axi_lite_ipif_v3_0_4 -L axi_uartlite_v2_0_39 -L dist_mem_gen_v8_0_17 -L interrupt_control_v3_1_5 -L axi_quad_spi_v3_2_34 -L axi_gpio_v2_0_37 -L axi_timer_v2_0_37 -L xlconcat_v2_1_7 -L axi_intc_v4_1_21 -L microblaze_v11_0_15 -L lmb_v10_v3_0_15 -L lmb_bram_if_cntlr_v4_0_26 -L blk_mem_gen_v8_4_11 -L mdm_v3_2_28 -L proc_sys_reset_v5_0_17 -L axi_bram_ctrl_v4_1_13 -L axi_protocol_converter_v2_1_36 -L axi_mmu_v2_1_33 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot slave xil_defaultlib.slave xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim slave -key {Behavioral:sim_1:Functional:slave} -tclbatch cmd.tcl -protoinst "protoinst_files/slave.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb slave.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./slave.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: slave.sh [-help]\n\
Usage: slave.sh [-step]\n\
Usage: slave.sh [-lib_map_path]\n\
Usage: slave.sh [-reset_run]\n\
Usage: slave.sh [-reset_log]\n\
Usage: slave.sh [-keep_index]\n\
Usage: slave.sh [-noclean_files]\n\n\
